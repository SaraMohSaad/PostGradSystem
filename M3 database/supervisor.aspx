...
<body>
    ...
    <div id="publication" class="loginbox2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Milestone3 %>" SelectCommand="ViewAStudentPublications" SelectCommandType="StoredProcedure">
                        <SelectParameters>
    ...
    <div class="loginbox1">
        ...
        <div class="loginbox3">
                                        <asp:TextBox ID="serialno"  runat ="server" CssClass="txtpass" placeholder="enter thesis serial num" />
            ...
            <br />
            <br />
                                        <asp:TextBox ID="add"  runat ="server" CssClass="txtpass" placeholder="enter examiner id" />
        ...
        <div class="loginbox4">
                                        <asp:TextBox ID="serialno2"  runat ="server" CssClass="txtpass" placeholder="enter thesis serial number" />
                                        <asp:TextBox ID="progrepno"  runat ="server" CssClass="txtpass" placeholder="enter progress repot num" />
