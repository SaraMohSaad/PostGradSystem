    ...
    <form id="form1" runat="server">
       ...
       <asp:Panel ID="Panel1"  Visible="false" runat="server">
         ...
         <div class="loginbox split right" >
             ...
             <asp:GridView ID="ThesisView" CssClass="table" runat="server" AutoGenerateColumns="False" DataKeyNames="serialNumber" DataSourceID="SqlDataSource2" Visible="false" Height="325px" Width="695px">
                 <Columns>
            ...
            <asp:GridView ID="SupervisorView" CssClass="table" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" Height="180px" Width="244px" Visible="false">
                <Columns>
            ...
            <h2> <asp:Label id="countNum" Text="" runat="server" Visible="false" /> </h2>
             ...
             <asp:Panel ID="paymentinfo"  Visible="false" runat="server">
                 <ul style="list-style-type:none;">
                     ...
                     <li> <asp:TextBox ID="amount"  runat ="server" CssClass="txtpass" placeholder="Enter payment amount" TextMode="Number"/> </li>
                     <li> <asp:TextBox ID="noOfInstall"  runat ="server" CssClass="txtpass" placeholder="Enter number of installments" TextMode="Number"/> </li>
                     <li> <asp:TextBox ID="percent"  runat ="server" CssClass="txtpass" placeholder="Enter fund percentage" TextMode="Number"/> </li>
                 </ul>
